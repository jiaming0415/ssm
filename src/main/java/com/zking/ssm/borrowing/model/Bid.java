...
public class Bid {
    ...
    public Bid(Long id, BigDecimal actualrate, BigDecimal availableamount, Long bidrequestId, Long biduserId, Date bidtime, String bidrequesttitle, Integer bidrequeststate) {
        this.id = id;
